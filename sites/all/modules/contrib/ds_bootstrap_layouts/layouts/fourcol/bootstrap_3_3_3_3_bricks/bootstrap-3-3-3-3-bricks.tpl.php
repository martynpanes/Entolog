...
<<?php print $layout_wrapper; print $layout_attributes; ?> class="<?php print $classes; ?>">
  ...
  <?php endif; ?>
  <?php if ($topleft || $topmiddleleft ||$topmiddleright || $topright) : ?>
    <div class="row">
      <<?php print $topleft_wrapper; ?> class="col-sm-3 <?php print $topleft_classes; ?>">
        <?php print $topleft; ?>
      </<?php print $topleft_wrapper; ?>>
       <<?php print $topmiddleleft_wrapper; ?> class="col-sm-3 <?php print $topmiddleleft_classes; ?>">
        <?php print $topmiddleleft; ?>
      </<?php print $topmiddleleft_wrapper; ?>>
       <<?php print $topmiddleright_wrapper; ?> class="col-sm-3 <?php print $topmiddleright_classes; ?>">
        <?php print $topmiddleright; ?>
      </<?php print $topmiddleright_wrapper; ?>>
      <<?php print $topright_wrapper; ?> class="col-sm-3 <?php print $topright_classes; ?>">
        <?php print $topright; ?>
